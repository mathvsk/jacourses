...
public class UpdateTaskUseCase {
    ...
    public void execute(String id, UpdateTaskDTO updateTaskDTO) throws NotFounException {
        var task = taskRepository.findById(UUID.fromString(id)).orElseThrow(() -> new NotFounException("Task not found"));
